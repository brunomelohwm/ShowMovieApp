...
void main() {
  ...
  void setUpMockHttpClientSuccess200() {
    when(mockHttpClient.get(Uri.parse('http://www.google.com'),
  ...
  group('getMoviePopular', () {
    ...
    test(
      '''should perform a GET request on a URL with MovieList being
       the endopoint and with application/json header''',
      () async {
