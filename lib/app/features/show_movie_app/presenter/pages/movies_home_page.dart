...
class _MoviesHomePageState extends State<MoviesHomePage> {
  ...
  void initState() {
    super.initState();
    blocMoviePopular = MoviePopularBloc(sl());
    blocMoviePopular.add(GetMoviePopularEvent());

    blocMovieFreeToWatch = MovieFreeToWatchBloc(sl());
  ...
  Widget buildBody(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (_) => sl<MoviePopularBloc>()),
        BlocProvider(create: (_) => sl<MovieFreeToWatchBloc>()),
      ],
      child: SafeArea(
        child: Column(
